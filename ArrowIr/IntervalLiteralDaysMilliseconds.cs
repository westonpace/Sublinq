...
public struct IntervalLiteralDaysMilliseconds : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.IntervalLiteralDaysMilliseconds> CreateIntervalLiteralDaysMilliseconds(FlatBufferBuilder builder,
      int days = 0,
      int milliseconds = 0) {
  ...
  public static Offset<Datalinq.ArrowIr.IntervalLiteralDaysMilliseconds> EndIntervalLiteralDaysMilliseconds(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.IntervalLiteralDaysMilliseconds>(o);
  }
};
