...
public struct Float16Literal : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.Float16Literal> CreateFloat16Literal(FlatBufferBuilder builder,
      ushort value = 0) {
  ...
  public static Offset<Datalinq.ArrowIr.Float16Literal> EndFloat16Literal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.Float16Literal>(o);
  }
};
