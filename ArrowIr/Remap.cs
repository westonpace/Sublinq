...
public struct Remap : IFlatbufferObject
{
  ...
  public Datalinq.ArrowIr.FieldIndex? Mapping(int j) { int o = __p.__offset(4); return o != 0 ? (Datalinq.ArrowIr.FieldIndex?)(new Datalinq.ArrowIr.FieldIndex()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int MappingLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<Datalinq.ArrowIr.Remap> CreateRemap(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateMappingVector(FlatBufferBuilder builder, Offset<Datalinq.ArrowIr.FieldIndex>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateMappingVectorBlock(FlatBufferBuilder builder, Offset<Datalinq.ArrowIr.FieldIndex>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartMappingVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<Datalinq.ArrowIr.Remap> EndRemap(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // mapping
    return new Offset<Datalinq.ArrowIr.Remap>(o);
  }
};
