...
public struct UInt32Literal : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.UInt32Literal> CreateUInt32Literal(FlatBufferBuilder builder,
      uint value = 0) {
  ...
  public static Offset<Datalinq.ArrowIr.UInt32Literal> EndUInt32Literal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.UInt32Literal>(o);
  }
};
