...
public struct Union : IFlatbufferObject
{
  ...
  public Datalinq.ArrowIr.Arrow.UnionMode Mode { get { int o = __p.__offset(4); return o != 0 ? (Datalinq.ArrowIr.Arrow.UnionMode)__p.bb.GetShort(o + __p.bb_pos) : Datalinq.ArrowIr.Arrow.UnionMode.Sparse; } }
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.Union> CreateUnion(FlatBufferBuilder builder,
      Datalinq.ArrowIr.Arrow.UnionMode mode = Datalinq.ArrowIr.Arrow.UnionMode.Sparse,
  ...
  public static void AddMode(FlatBufferBuilder builder, Datalinq.ArrowIr.Arrow.UnionMode mode) { builder.AddShort(0, (short)mode, 0); }
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.Union> EndUnion(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.Arrow.Union>(o);
  }
};
