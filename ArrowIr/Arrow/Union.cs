...
public struct Union : IFlatbufferObject
{
  ...
  public SubLinq.ArrowIr.Arrow.UnionMode Mode { get { int o = __p.__offset(4); return o != 0 ? (SubLinq.ArrowIr.Arrow.UnionMode)__p.bb.GetShort(o + __p.bb_pos) : SubLinq.ArrowIr.Arrow.UnionMode.Sparse; } }
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Union> CreateUnion(FlatBufferBuilder builder,
      SubLinq.ArrowIr.Arrow.UnionMode mode = SubLinq.ArrowIr.Arrow.UnionMode.Sparse,
  ...
  public static void AddMode(FlatBufferBuilder builder, SubLinq.ArrowIr.Arrow.UnionMode mode) { builder.AddShort(0, (short)mode, 0); }
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Union> EndUnion(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.Arrow.Union>(o);
  }
};
