...
public struct Time : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Time> CreateTime(FlatBufferBuilder builder,
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Time> EndTime(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.Arrow.Time>(o);
  }
};
