...
public struct FixedSizeBinary : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.FixedSizeBinary> CreateFixedSizeBinary(FlatBufferBuilder builder,
      int byteWidth = 0) {
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.FixedSizeBinary> EndFixedSizeBinary(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.Arrow.FixedSizeBinary>(o);
  }
};
