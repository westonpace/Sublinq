...
public struct FixedSizeBinary : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.FixedSizeBinary> CreateFixedSizeBinary(FlatBufferBuilder builder,
      int byteWidth = 0) {
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.FixedSizeBinary> EndFixedSizeBinary(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.Arrow.FixedSizeBinary>(o);
  }
};
