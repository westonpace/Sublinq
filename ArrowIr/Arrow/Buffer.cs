...
public struct Buffer : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.Buffer> CreateBuffer(FlatBufferBuilder builder, long Offset, long Length) {
    builder.Prep(8, 16);
    builder.PutLong(Length);
    builder.PutLong(Offset);
    return new Offset<Datalinq.ArrowIr.Arrow.Buffer>(builder.Offset);
  }
};
