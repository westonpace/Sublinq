...
public struct Int : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Int> CreateInt(FlatBufferBuilder builder,
      int bitWidth = 0,
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Int> EndInt(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.Arrow.Int>(o);
  }
};
