...
public struct LargeList : IFlatbufferObject
{
  private Table __p;
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.LargeList> EndLargeList(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.Arrow.LargeList>(o);
  }
};
