...
public struct LargeBinary : IFlatbufferObject
{
  private Table __p;
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.LargeBinary> EndLargeBinary(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.Arrow.LargeBinary>(o);
  }
};
