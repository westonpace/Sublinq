...
public struct FixedSizeList : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.FixedSizeList> CreateFixedSizeList(FlatBufferBuilder builder,
      int listSize = 0) {
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.FixedSizeList> EndFixedSizeList(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.Arrow.FixedSizeList>(o);
  }
};
