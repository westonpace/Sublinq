...
public struct Decimal : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.Decimal> CreateDecimal(FlatBufferBuilder builder,
      int precision = 0,
      int scale = 0,
      int bitWidth = 128) {
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.Decimal> EndDecimal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.Arrow.Decimal>(o);
  }
};
