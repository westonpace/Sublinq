...
public struct Decimal : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Decimal> CreateDecimal(FlatBufferBuilder builder,
      int precision = 0,
      int scale = 0,
      int bitWidth = 128) {
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Decimal> EndDecimal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.Arrow.Decimal>(o);
  }
};
