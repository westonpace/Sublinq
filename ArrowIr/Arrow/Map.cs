...
public struct Map : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Map> CreateMap(FlatBufferBuilder builder,
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Map> EndMap(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.Arrow.Map>(o);
  }
};
