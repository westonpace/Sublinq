...
public struct Map : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.Map> CreateMap(FlatBufferBuilder builder,
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.Map> EndMap(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.Arrow.Map>(o);
  }
};
