...
public struct Timestamp : IFlatbufferObject
{
  ...
  public SubLinq.ArrowIr.Arrow.TimeUnit Unit { get { int o = __p.__offset(4); return o != 0 ? (SubLinq.ArrowIr.Arrow.TimeUnit)__p.bb.GetShort(o + __p.bb_pos) : SubLinq.ArrowIr.Arrow.TimeUnit.SECOND; } }
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Timestamp> CreateTimestamp(FlatBufferBuilder builder,
      SubLinq.ArrowIr.Arrow.TimeUnit unit = SubLinq.ArrowIr.Arrow.TimeUnit.SECOND,
  ...
  public static void AddUnit(FlatBufferBuilder builder, SubLinq.ArrowIr.Arrow.TimeUnit unit) { builder.AddShort(0, (short)unit, 0); }
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.Timestamp> EndTimestamp(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.Arrow.Timestamp>(o);
  }
};
