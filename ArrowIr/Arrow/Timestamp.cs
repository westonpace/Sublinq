...
public struct Timestamp : IFlatbufferObject
{
  ...
  public Datalinq.ArrowIr.Arrow.TimeUnit Unit { get { int o = __p.__offset(4); return o != 0 ? (Datalinq.ArrowIr.Arrow.TimeUnit)__p.bb.GetShort(o + __p.bb_pos) : Datalinq.ArrowIr.Arrow.TimeUnit.SECOND; } }
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.Timestamp> CreateTimestamp(FlatBufferBuilder builder,
      Datalinq.ArrowIr.Arrow.TimeUnit unit = Datalinq.ArrowIr.Arrow.TimeUnit.SECOND,
  ...
  public static void AddUnit(FlatBufferBuilder builder, Datalinq.ArrowIr.Arrow.TimeUnit unit) { builder.AddShort(0, (short)unit, 0); }
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.Timestamp> EndTimestamp(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.Arrow.Timestamp>(o);
  }
};
