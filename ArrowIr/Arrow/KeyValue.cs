...
public struct KeyValue : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.KeyValue> CreateKeyValue(FlatBufferBuilder builder,
  ...
  public static Offset<SubLinq.ArrowIr.Arrow.KeyValue> EndKeyValue(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.Arrow.KeyValue>(o);
  }
};
