...
public struct KeyValue : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.KeyValue> CreateKeyValue(FlatBufferBuilder builder,
  ...
  public static Offset<Datalinq.ArrowIr.Arrow.KeyValue> EndKeyValue(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.Arrow.KeyValue>(o);
  }
};
