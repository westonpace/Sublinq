...
public struct BooleanLiteral : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.BooleanLiteral> CreateBooleanLiteral(FlatBufferBuilder builder,
      bool value = false) {
  ...
  public static Offset<Datalinq.ArrowIr.BooleanLiteral> EndBooleanLiteral(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.BooleanLiteral>(o);
  }
};
