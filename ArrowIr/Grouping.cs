...
public struct Grouping : IFlatbufferObject
{
  ...
  public SubLinq.ArrowIr.Expression? Keys(int j) { int o = __p.__offset(4); return o != 0 ? (SubLinq.ArrowIr.Expression?)(new SubLinq.ArrowIr.Expression()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int KeysLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<SubLinq.ArrowIr.Grouping> CreateGrouping(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateKeysVector(FlatBufferBuilder builder, Offset<SubLinq.ArrowIr.Expression>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateKeysVectorBlock(FlatBufferBuilder builder, Offset<SubLinq.ArrowIr.Expression>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartKeysVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<SubLinq.ArrowIr.Grouping> EndGrouping(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // keys
    return new Offset<SubLinq.ArrowIr.Grouping>(o);
  }
};
