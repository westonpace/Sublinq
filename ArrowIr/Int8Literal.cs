...
public struct Int8Literal : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.Int8Literal> CreateInt8Literal(FlatBufferBuilder builder,
      sbyte value = 0) {
  ...
  public static Offset<Datalinq.ArrowIr.Int8Literal> EndInt8Literal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.Int8Literal>(o);
  }
};
