...
public struct UInt8Literal : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.UInt8Literal> CreateUInt8Literal(FlatBufferBuilder builder,
      byte value = 0) {
  ...
  public static Offset<Datalinq.ArrowIr.UInt8Literal> EndUInt8Literal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.UInt8Literal>(o);
  }
};
