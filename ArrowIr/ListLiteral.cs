...
public struct ListLiteral : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.ListLiteral> CreateListLiteral(FlatBufferBuilder builder,
  ...
  public static Offset<Datalinq.ArrowIr.ListLiteral> EndListLiteral(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // values
    return new Offset<Datalinq.ArrowIr.ListLiteral>(o);
  }
};
