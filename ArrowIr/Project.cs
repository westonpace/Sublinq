...
public struct Project : IFlatbufferObject
{
  ...
  public Datalinq.ArrowIr.Expression? Expressions(int j) { int o = __p.__offset(8); return o != 0 ? (Datalinq.ArrowIr.Expression?)(new Datalinq.ArrowIr.Expression()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int ExpressionsLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<Datalinq.ArrowIr.Project> CreateProject(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateExpressionsVector(FlatBufferBuilder builder, Offset<Datalinq.ArrowIr.Expression>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateExpressionsVectorBlock(FlatBufferBuilder builder, Offset<Datalinq.ArrowIr.Expression>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartExpressionsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<Datalinq.ArrowIr.Project> EndProject(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // base
    builder.Required(o, 6);  // rel
    builder.Required(o, 8);  // expressions
    return new Offset<Datalinq.ArrowIr.Project>(o);
  }
};
