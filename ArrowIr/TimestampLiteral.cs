...
public struct TimestampLiteral : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.TimestampLiteral> CreateTimestampLiteral(FlatBufferBuilder builder,
      long value = 0) {
  ...
  public static Offset<Datalinq.ArrowIr.TimestampLiteral> EndTimestampLiteral(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.TimestampLiteral>(o);
  }
};
