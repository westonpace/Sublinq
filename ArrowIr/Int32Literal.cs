...
public struct Int32Literal : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.Int32Literal> CreateInt32Literal(FlatBufferBuilder builder,
      int value = 0) {
  ...
  public static Offset<SubLinq.ArrowIr.Int32Literal> EndInt32Literal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.Int32Literal>(o);
  }
};
