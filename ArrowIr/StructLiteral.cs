...
public struct StructLiteral : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.StructLiteral> CreateStructLiteral(FlatBufferBuilder builder,
  ...
  public static Offset<SubLinq.ArrowIr.StructLiteral> EndStructLiteral(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // values
    return new Offset<SubLinq.ArrowIr.StructLiteral>(o);
  }
};
