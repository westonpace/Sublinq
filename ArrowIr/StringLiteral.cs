...
public struct StringLiteral : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.StringLiteral> CreateStringLiteral(FlatBufferBuilder builder,
  ...
  public static Offset<Datalinq.ArrowIr.StringLiteral> EndStringLiteral(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // value
    return new Offset<Datalinq.ArrowIr.StringLiteral>(o);
  }
};
