...
public struct ArraySlice : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.ArraySlice> CreateArraySlice(FlatBufferBuilder builder,
  ...
  public static Offset<SubLinq.ArrowIr.ArraySlice> EndArraySlice(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.ArraySlice>(o);
  }
};
