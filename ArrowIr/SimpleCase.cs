...
public struct SimpleCase : IFlatbufferObject
{
  ...
  public SubLinq.ArrowIr.CaseFragment? Matches(int j) { int o = __p.__offset(6); return o != 0 ? (SubLinq.ArrowIr.CaseFragment?)(new SubLinq.ArrowIr.CaseFragment()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int MatchesLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// The default value if no cases match
  public SubLinq.ArrowIr.Expression? Else { get { int o = __p.__offset(8); return o != 0 ? (SubLinq.ArrowIr.Expression?)(new SubLinq.ArrowIr.Expression()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }

  public static Offset<SubLinq.ArrowIr.SimpleCase> CreateSimpleCase(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateMatchesVector(FlatBufferBuilder builder, Offset<SubLinq.ArrowIr.CaseFragment>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateMatchesVectorBlock(FlatBufferBuilder builder, Offset<SubLinq.ArrowIr.CaseFragment>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartMatchesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddElse(FlatBufferBuilder builder, Offset<SubLinq.ArrowIr.Expression> elseOffset) { builder.AddOffset(2, elseOffset.Value, 0); }
  public static Offset<SubLinq.ArrowIr.SimpleCase> EndSimpleCase(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // expression
    builder.Required(o, 6);  // matches
    builder.Required(o, 8);  // else
    return new Offset<SubLinq.ArrowIr.SimpleCase>(o);
  }
};
