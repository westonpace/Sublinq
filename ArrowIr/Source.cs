...
public struct Source : IFlatbufferObject
{
  ...
  public Datalinq.ArrowIr.Arrow.Schema? Schema { get { int o = __p.__offset(8); return o != 0 ? (Datalinq.ArrowIr.Arrow.Schema?)(new Datalinq.ArrowIr.Arrow.Schema()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }

  public static Offset<Datalinq.ArrowIr.Source> CreateSource(FlatBufferBuilder builder,
      Offset<Datalinq.ArrowIr.RelBase> baseOffset = default(Offset<Datalinq.ArrowIr.RelBase>),
      StringOffset nameOffset = default(StringOffset),
      Offset<Datalinq.ArrowIr.Arrow.Schema> schemaOffset = default(Offset<Datalinq.ArrowIr.Arrow.Schema>)) {
  ...
  public static void AddSchema(FlatBufferBuilder builder, Offset<Datalinq.ArrowIr.Arrow.Schema> schemaOffset) { builder.AddOffset(2, schemaOffset.Value, 0); }
  public static Offset<Datalinq.ArrowIr.Source> EndSource(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // base
    builder.Required(o, 6);  // name
    builder.Required(o, 8);  // schema
    return new Offset<Datalinq.ArrowIr.Source>(o);
  }
};
