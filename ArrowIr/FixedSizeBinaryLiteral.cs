...
public struct FixedSizeBinaryLiteral : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.FixedSizeBinaryLiteral> CreateFixedSizeBinaryLiteral(FlatBufferBuilder builder,
  ...
  public static Offset<Datalinq.ArrowIr.FixedSizeBinaryLiteral> EndFixedSizeBinaryLiteral(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // value
    return new Offset<Datalinq.ArrowIr.FixedSizeBinaryLiteral>(o);
  }
};
