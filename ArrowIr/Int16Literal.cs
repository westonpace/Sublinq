...
public struct Int16Literal : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.Int16Literal> CreateInt16Literal(FlatBufferBuilder builder,
      short value = 0) {
  ...
  public static Offset<SubLinq.ArrowIr.Int16Literal> EndInt16Literal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.Int16Literal>(o);
  }
};
