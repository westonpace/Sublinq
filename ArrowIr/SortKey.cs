...
public struct SortKey : IFlatbufferObject
{
  ...
  public SubLinq.ArrowIr.Ordering Ordering { get { int o = __p.__offset(6); return o != 0 ? (SubLinq.ArrowIr.Ordering)__p.bb.Get(o + __p.bb_pos) : SubLinq.ArrowIr.Ordering.ASCENDING_THEN_NULLS; } }

  public static Offset<SubLinq.ArrowIr.SortKey> CreateSortKey(FlatBufferBuilder builder,
      Offset<SubLinq.ArrowIr.Expression> expressionOffset = default(Offset<SubLinq.ArrowIr.Expression>),
      SubLinq.ArrowIr.Ordering ordering = SubLinq.ArrowIr.Ordering.ASCENDING_THEN_NULLS) {
  ...
  public static void AddOrdering(FlatBufferBuilder builder, SubLinq.ArrowIr.Ordering ordering) { builder.AddByte(1, (byte)ordering, 0); }
  public static Offset<SubLinq.ArrowIr.SortKey> EndSortKey(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // expression
    return new Offset<SubLinq.ArrowIr.SortKey>(o);
  }
};
