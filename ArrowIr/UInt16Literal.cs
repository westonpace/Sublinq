...
public struct UInt16Literal : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.UInt16Literal> CreateUInt16Literal(FlatBufferBuilder builder,
      ushort value = 0) {
  ...
  public static Offset<Datalinq.ArrowIr.UInt16Literal> EndUInt16Literal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.UInt16Literal>(o);
  }
};
