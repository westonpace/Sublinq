...
public struct BinaryLiteral : IFlatbufferObject
{
  private Table __p;
  ...
  public static BinaryLiteral GetRootAsBinaryLiteral(ByteBuffer _bb, BinaryLiteral obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public static Offset<Datalinq.ArrowIr.BinaryLiteral> CreateBinaryLiteral(FlatBufferBuilder builder,
  ...
  public static Offset<Datalinq.ArrowIr.BinaryLiteral> EndBinaryLiteral(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // value
    return new Offset<Datalinq.ArrowIr.BinaryLiteral>(o);
  }
};
