...
public struct BinaryLiteral : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.BinaryLiteral> CreateBinaryLiteral(FlatBufferBuilder builder,
  ...
  public static Offset<SubLinq.ArrowIr.BinaryLiteral> EndBinaryLiteral(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // value
    return new Offset<SubLinq.ArrowIr.BinaryLiteral>(o);
  }
};
