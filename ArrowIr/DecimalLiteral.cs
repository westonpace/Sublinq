...
public struct DecimalLiteral : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.DecimalLiteral> CreateDecimalLiteral(FlatBufferBuilder builder,
  ...
  public static Offset<Datalinq.ArrowIr.DecimalLiteral> EndDecimalLiteral(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // value
    return new Offset<Datalinq.ArrowIr.DecimalLiteral>(o);
  }
};
