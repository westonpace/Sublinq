...
public struct Float64Literal : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.Float64Literal> CreateFloat64Literal(FlatBufferBuilder builder,
      double value = 0.0) {
  ...
  public static Offset<Datalinq.ArrowIr.Float64Literal> EndFloat64Literal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.Float64Literal>(o);
  }
};
