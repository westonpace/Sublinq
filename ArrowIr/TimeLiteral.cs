...
public struct TimeLiteral : IFlatbufferObject
{
  ...
  public static Offset<Datalinq.ArrowIr.TimeLiteral> CreateTimeLiteral(FlatBufferBuilder builder,
      long value = 0) {
  ...
  public static Offset<Datalinq.ArrowIr.TimeLiteral> EndTimeLiteral(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Datalinq.ArrowIr.TimeLiteral>(o);
  }
};
