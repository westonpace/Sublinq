...
public struct UInt64Literal : IFlatbufferObject
{
  ...
  public static Offset<SubLinq.ArrowIr.UInt64Literal> CreateUInt64Literal(FlatBufferBuilder builder,
      ulong value = 0) {
  ...
  public static Offset<SubLinq.ArrowIr.UInt64Literal> EndUInt64Literal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SubLinq.ArrowIr.UInt64Literal>(o);
  }
};
